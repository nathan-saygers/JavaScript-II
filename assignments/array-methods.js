...
console.log(`Challenge 1: ${fullNames}`);
...
console.log(`Challenge 2: ${firstNamesAllCaps}`);

// ==== Challenge 3: Use .filter() ====
// The large shirts won't be available for the event due to an ordering issue. We need a 
// filtered version of the runners array, containing only those runners with large sized shirts 
...
// and save the total into a ticketPriceTotal variable.
